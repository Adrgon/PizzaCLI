...
server.unifiedServer = function (req, res) {
    ...
    req.on('end', function () {
        ...
        // Order the router for a matching path for a handler. If one is not found, use the notFound handler instead.
        ...
        //debug(`Invoking handler: ${trimmedPath} with payload ${JSON.stringify(data.payload)} with data\n\n${JSON.stringify(data)}`);
...
server.router = {
    ...
    'purchase': handlers.purchaseCreate,
    'ping': handlers.ping,
